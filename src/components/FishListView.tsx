                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex gap-2">
                        <input
                          ...
                          className="w-24 rounded-xl border border-white/20 bg-white/15 text-white placeholder-white/40 px-3 py-2 text-sm text-center focus:outline-none focus:ring-2 focus:ring-cyan-400"
                        />
                        <span className="flex items-center text-sm text-white/60">匹</span>
                        <input
                          type="text"
                          placeholder="メモ（任意）"
                          value={newNote}
                          ...
                          onKeyDown={e => e.key === 'Enter' && handleAdd()}
                          className="flex-1 rounded-xl border border-white/20 bg-white/15 text-white placeholder-white/40 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-cyan-400"
                        />
                      </div>
                      <button
                        onClick={handleAdd}
