          ...
          <div className="flex items-center justify-between px-5 pt-2 pb-3 shrink-0 border-b border-slate-100">
            <div>
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-base font-black text-slate-900">未着一覧（新宿）</h2>
                {!loading && (
          ...
          <div className="overflow-y-auto px-4 pt-3 pb-10 flex-1">
            {loading ? (
              ...
              <div className="py-12 text-center flex flex-col items-center gap-3">
                ...
                <div className="text-xs text-slate-400">新宿着のアイテムはすべて完了済みです</div>
              </div>
            ) : (
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex items-center gap-1.5 mt-0.5 flex-wrap">
                                ...
                                {item.arrivalDate ? (
                                  ...
                                  <span className="text-[10px] text-slate-400">日付未設定</span>
                                )}
                                {item.quantity > 1 && (
